...
import { Menu, Goal, Trophy, Ticket, ChevronDown, LogOut, UserRound } from "lucide-react";
    ...
    <header className="sticky top-0 z-40 border-b border-border bg-background/85 backdrop-blur supports-backdrop-filter:bg-background/70 px-4 sm:px-6 lg:px-8 text-foreground">
      ...
      <div className="container mx-auto flex h-16 items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <Badge className="gap-1.5 px-3 py-1.5 text-xs font-bold tracking-wide shadow-[0_0_14px_-4px_rgba(194,112,10,0.5)]">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="group flex items-center gap-1 outline-none">
              <Avatar className="h-9 w-9 cursor-pointer border-2 border-gold/70 shadow-[0_0_0_3px_rgba(194,112,10,0.08)] transition-all duration-300 group-hover:scale-105 group-hover:shadow-[0_0_0_4px_rgba(194,112,10,0.18)]">
                <AvatarFallback className="bg-secondary font-bold text-amber-500">
            ...
            >
              ...
              <DropdownMenuItem
                variant="danger"
                onClick={logout}
                className="gap-2 font-medium text-red-600 dark:text-red-500"
              >
          ...
          <Sheet>
            ...
            >
              ...
              <div className="flex flex-col gap-1 p-5">
                <div className="mb-4 flex items-center gap-3 rounded-2xl border border-gold/20 bg-gradient-to-br from-amber-600/10 to-orange-600/5 p-4">
                ...
                <div className="my-3 border-t border-border" />
                  ...
                  <Button
                    asChild
                    variant="ghost"
                    className="justify-start w-full gap-2.5 text-foreground/75 hover:bg-foreground/5"
                  >
                    <Link href="/about">
                      <UserRound className="h-4 w-4" />
                      Behind The Scene
                  ...
                  <Button
                    className="mt-2 w-full gap-2 bg-red-900 text-white hover:bg-red-950"
                    onClick={logout}
                  >
                    <LogOut className="h-4 w-4" />
                    Logout
