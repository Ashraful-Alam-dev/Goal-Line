...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex h-screen items-center justify-center bg-background overflow-hidden px-4">
      ...
      <div className="pointer-events-none absolute -top-32 -left-32 h-[420px] w-[420px] rounded-full bg-amber-600/15 blur-[110px]" />
      <div className="pointer-events-none absolute -bottom-32 -right-32 h-[420px] w-[420px] rounded-full bg-orange-700/15 blur-[110px]" />
      <div
        aria-hidden
        ...
        <div className="p-6 space-y-4">
          <div className="text-center space-y-2 pb-1">
            ...
            <h1 className="text-sm font-medium text-foreground/60">
              Welcome back — ready to call the odds?
            </h1>
          </div>
